...
d3.json(queryUrl, function(quakeData) {
  ...
  testing = "s/PB2002_boundaries.json";
  deployment = "https://s3.us-east-2.amazonaws.com/thrum.engineering.com/PB2002_boundaries.json";
  // Pull tectonic plate data from json
  d3.json(deployment, function(tectonicData) {
